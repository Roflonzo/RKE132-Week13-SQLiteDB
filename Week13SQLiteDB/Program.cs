...
static void ReadData(SQLiteConnection myConnection)
{
    ...
    while (reader.Read())
    {
        ...
        Console.WriteLine($"{readerRowId}. Full name: {readerStringFirstname} {readerStringLastname} D0B: {readerStringDoB}");
    }
}
...
static void InsertCustomer(SQLiteConnection myConnection)
{
    ...
    Console.WriteLine("Enter date of birrth (mm-dd-yyyy):");
